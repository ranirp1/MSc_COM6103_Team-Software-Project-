                  ...
                  >
                    ...
                    <div className="absolute bottom-0 py-5 left-0 p-10 z-10 text-center flex justify-center items-center w-full">
                      <div className="text-primary">
                        ...
                        <p>
                          Electronic waste (e-waste) is all the old types of
                          old, end-of-life, or discarded electrical and
                    ...
                    <div className="absolute bottom-0 left-0 p-10 z-10 text-center flex justify-center items-center w-full">
                      <div className="text-primary">
                        ...
                        <p>
                          ...
                          sensitive information stored on your electronic
                          devices is securely recovered and protected.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="absolute bottom-0 left-0 p-5 z-10 text-center flex justify-center items-center w-full">
                      <div className="text-primary">
                        ...
                        <p>
                          ...
                          for our users. From traditional methods like credit
                          and debit cards to modern alternatives such as digital
                          wallets.
                        </p>
                      </div>
                    </div>
            ...
            <div className="hero h-full">
              <div className="hero-content flex flex-col lg:flex-row-reverse h-full">
                <div className="text-center flex flex-col justify-center items-center lg:text-left">
                  ...
                  <div className="card shrink-0 h-full w-full md:w-[80vh] max-w-[90%] max-w-sm shadow-2xl bg-base-100">
                            ...
                            <Tippy
                              content={
                                <div>
                                  ...
                                  <p>
                                    <strong>Rare:</strong> Unique or older
                                    devices that may be valuable to collectors
                                    or for specific parts.
                                  </p>
                                  <p>
                                    <strong>Unknown:</strong> Devices that
                                    require further evaluation to determine
                                    their classification.
                                  </p>
                                  <p>
                                    <strong>Recycle:</strong> Devices that are
                                    best suited for recycling due to age,
                                    condition, or lack of demand.
                                  </p>
                                </div>
                              }
                            >
